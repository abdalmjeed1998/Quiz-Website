...
const quizData = [
    ...
    {
      question: "What is the main purpose of indentation in Python?",
      options: [
        "To make your code look nice",
        "To create block comments",
        "To define function names",
        "To indicate the structure of the code",
      ],
      correctAnswer: 3,
    },
    {
    ...
    },
    {
      ...
      // Add more Python-related questions here...
    ];
